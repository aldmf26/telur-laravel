...
@section('content')
                    ...
                    <div class="card card-statistic-1">
                        ...
                        <div class="card-wrap">
                            <div class="card-header">
                                <h3>Stok Rak Telur : {{number_format($stokRakTelur->debit - $stokRakTelur->kredit,0)}} Pcs</h4>
                            </div>
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            ...
                                            <a href="{{ route('deleteRakTelur', $s->no_nota) }}" onclick="return confirm('Apakah yaking dihapus ?')"
    ...
    {{-- tambah data --}}
    <form action="{{ route('addRakTelur') }}" method="post">
        @csrf
    ...
    {{-- ubah data --}}
    <form action="{{ route('editRakTelur') }}" method="post">
        @csrf
